...
<head>
  ...
  <script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAFUiZBCYmwccIFBcx5jWTFwK_bwzVPmwo&libraries=places%22%3E"></script>
...
<body>
  ...
  <!--====== HEADER START ======-->
  <header class="sotcox-header pt-50 pb-50 uk-sticky" data-uk-sticky="top: 250; animation: uk-animation-slide-top;">
                        ...
                        <div class="sotcox-main-menu">
                            <nav id="sotcox-navbar" style="display: inline-block;">
                                <ul>
                                    ...
                                    <li class="active"><a class="title-font" href="./contact.html">Contact</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="side-info">
          <div class="side-info__content mb-35">
            ...
            <p class="text-justify"> WE NETWORK LLC posses specialized expertise in designing and implementing networks
              ...
              planning, design, and optimization across all segments.

              Our primary services are centered around Network and Network-related solutions, catering
  ...
  <section class="breadcrumb-area fix wow fadeInUp" style="height: 130px; background-color: #4cdf84;"
    data-wow-delay="300ms" data-wow-duration="800ms">
    <div class="container">
      <div class="row">
        <div class="col-xl-12">
          <div class="sotcox-breadcrumb-wrapper breadcrumb-new position-relative">
            <h2 class="page-title title-font mt-25">Contact us </h2>
            <div class="right-img">
            </div>
          </div>
        </div>
  ...
  <section class="sotcox-about-section theme-light-bg pb-90 wow fadeInUp" data-wow-delay="300ms"
    data-wow-duration="800ms">
    <div class="container">
      <div class="row justify-content-left">
        <div class="col-xl-8">
          <div class="sotcox-post-box sotcox-onhover-zoom format format-image mt-70 pb-60">
            <div class="content">
              <h2 class="title border-effect ms-2">
                <a class="title-font">Let's Connect</a>
              </h2>
            </div>
          </div>
        </div>
      ...
      <div class="row g-0">
        <div class="col-xl-6 sotcox-onhover-zoom">
          <div class="img-wrapper thumb d-lg-block d-none">
            <img src="./assets/img/Contact/contact-5.jpg" style="height:45em;" alt="">
          </div>
        </div>
        <div class="col-xl-6">
          ...
          <p class="ajax-response <?php echo isset($_GET['error']) ? 'text-danger' : 'text-success' ?> "> <?php echo isset($_GET['error']) ? 'OOPS! Something went wrong, Please try again later':'Thanks for contacting us! Our team will contact yu soon.'   ?></p>
            ...
            <form action="contact-us.php" method="POST" id="contact-form">
              ...
              <div class="sotcox-input-field mt-30">
                <label class="title-font" for="company">Company *</label>
                <input type="text" name="company" id="company" placeholder="Company">
              </div>
              <div class="sotcox-input-field mt-30">
                <label class="title-font" for="email">Email *</label>
                <input type="email" name="email" id="email" placeholder="Email">
              </div>
              <div class="sotcox-input-field mt-30">
                <label class="title-font" for="email">Mobile *</label>
                <input type="text" name="phoneNumber" id="phoneNumber" placeholder="Mobiile Number">
              </div>
              <div class="sotcox-input-field mt-30">
  ...
  <!--====== MAP SECTION END ======-->
  <div class="sotcox-details-page sotcox-team-details-page pt-80 pb-90">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 align-self-center">
          <div class="team-info ">
            <h4 class="title-font name">We're Here</h4>
            <ul class="list-unstyled">
              <li><i class="far fa-map-marker-alt"></i><span class="title-font">Corporate Office:</span>
                <p class="pl-30">
                  We Network LLC <br>
                  First floor, 0401-Z-319-KOM-4,<br>
                  Knowledge Oasis Muscat, <br>
                  PO BOX: 1641, Postal Code: 114 <br>
                  Al Rusayl, Muscat, Sultanate of Oman.
                </p>
              </li>
              <li><i class="far fa-map-marker-alt"></i><span class="title-font">Office Address:</span>
                <p class="pl-30">We Network LLC,<br>
                  Office No - 222,<br>
              ...
              <li><i class="far fa-envelope"></i><span class="title-font">E-mail: </span>
                <p class="pl-30">info@wenetworkllc.com</p>
              </li>
              <li><i class="fas fa-phone"></i><span class="title-font">Phone: </span>
                <p class="pl-30">+968 24170030
                </p>
              </li>
            </ul>
          </div>
        ...
        <div class="col-lg-8 align-self-center">
          <iframe class="sotcox-map-section wow fadeInUp " data-wow-delay="300ms" data-wow-duration="800ms"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d43178609.11811688!2d52.79175393170654!3d19.883633829589712!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e8de2a72a631239%3A0x54e7a2a1f135af86!2zV2UgTmV0d29yayBMTEMg2LTYqNmD2Kkg2YjZig!5e0!3m2!1sen!2sin!4v1696347954695!5m2!1sen!2sin"
            style="height: 400px; border-radius: 20px; width: 100%; top: 0px;" allowfullscreen="" loading="lazy"
  ...
  <!-- Address Section -->
  <div class="sotcox-service-section theme-light-bg sotcox-service-section-page pt-60 pb-90">
    <div class="container">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 mt-30 justify-content-center">
          <div class="sotcox-service-item contact-address pt-30">
            <div class="row">
              ...
              <div class="col-lg-10">
                <p><b class="title-font">Integrated Communication Service Technology and Business LLC,</b><br>
                  PO BOX: 3360, Postal Code:111,<br>
                  Al Mabialah, Sultanate of Oman.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
          <div class="sotcox-service-item contact-address pt-30">
            <div class="row">
              ...
              <div class="col-lg-10">
                <p><b class="title-font">We Communication Network LLC,</b><br>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
          <div class="sotcox-service-item contact-address pt-30">
            <div class="row">
              ...
              <div class="col-lg-10">
                <p>
                  <b class="title-font">VYK Network Private Limited,</b><br>
                  Villa No-38, Ansal Town,<br>
                  Talawali Chanda, A B Road, Indore.<br>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 mt-30 justify-content-center">
          <div class="sotcox-service-item contact-address pt-30">
            <div class="row">
              ...
              <div class="col-lg-10">
                <p><b class="title-font">Malwa Retreat Mandu</b><br>
                  Naka main road, Mandu Dist. Dhar,<br>
                  Madhya Pradesh,<br> Pincode: 454020
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 mt-30 justify-content-center">
          <div class="sotcox-service-item contact-address pt-30">
            <div class="row">
              ...
              <div class="col-lg-10">
                <p><b class="title-font">Oasis Badminton Academy</b><br>
                  Street No-319, Building-1510/1,<br>
                  PO:3369, PC-111<br>
                  Ghala industrial area, Bousher<br>
            ...
            <div class="widget">
              ...
              <ul>
                <li><a class="text-light telecom-service" href="telecomTower.html">Telecom Network and Infrastructure
                    Solutions</a></li>
                <li>
                  <a class="text-light" href="iCTServices.html">Enterprise IT Solutions
                    Optimization</a>
                </li>
                <li><a class="text-light" href="services.html">MEP Solution</a></li>
                <li><a class="text-light" href="services.html">Oil & Gas Service</a></li>
                <li><a class="text-light" href="services.html">Managed Services</a></li>
              </ul>
            </div>
          </div>
          <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 sotcox-custom-col mt-75">
            <div class="widget">
              ...
              <ul>
                ...
                <li class="active"><a class="text-light" href="./contact.html">Contact us</a></li>
                <li><a class="text-light" href="./assets/Company Profile/WE_NETWORK_PROFILE_-_2023_NEW.pdf">Company
                    Profile</a></li>
              </ul>
            </div>
          </div>
